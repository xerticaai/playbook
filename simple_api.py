...
app = FastAPI(
    ...
    description="BigQuery data with dynamic date filters + AI Analysis + Insights + Performance",
    version="2.3.0"
)
...
async def root():
    ...
    if html_path.exists():
        ...
        return {
            "message": "Sales Intelligence API v2.3",
            "version": "2.3.0",
...
def get_pipeline(year: Optional[int] = None, quarter: Optional[int] = None, month: Optional[int] = None, seller: Optional[str] = None, limit: int = 2000):
...
def get_closed_won(year: Optional[int] = None, quarter: Optional[int] = None, month: Optional[int] = None, seller: Optional[str] = None, limit: int = 5000):
...
def get_closed_lost(year: Optional[int] = None, quarter: Optional[int] = None, month: Optional[int] = None, seller: Optional[str] = None, limit: int = 5000):
...
def get_sales_specialist(year: Optional[int] = None, quarter: Optional[int] = None, seller: Optional[str] = None):
